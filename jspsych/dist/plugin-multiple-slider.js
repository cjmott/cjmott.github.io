    ...
    class MultipleSliderPlugin {
        ...
        trial(display_element, trial) {
            ...
            if (trial.preamble !== null) {
                ...
                html +=
                    '<div style="position: relative; width:100%" id="jspsych-multiple-slider-preamble" class="jspsych-multiple-slider-preamble">' +
                    trial.preamble +
                    "</div><br>"
            }
            ...
            if (trial.autocomplete) {
                ...
                html +=
                    '<form id="jspsych-multiple-slider-form" autocomplete="off">'
            }
            ...
            for (var i = 0; i < trial.questions.length; i++) {
                ...
                // add prompt
                html +=
                    '<label class="jspsych-multiple-slider-statement">' +
                    question.prompt +
                    "</label><br>"
            ...
            // add submit button
            html +=
                '<input type="submit" id="jspsych-multiple-slider-next" class="jspsych-multiple-slider jspsych-btn" value="' +
                trial.button_label +
                '"></input>'
            ...
            display_element
                .querySelector("#jspsych-multiple-slider-form")
